...
// Row <-> state mapping used to live inline here — moved to lib/mappers.js
// (2026-09, Reports feature) so app/api/reports/* (plain server modules, not
// 'use client') can load/shape rows identically without importing this
// client-only file. Pure relocation; re-exported unchanged so any future
// caller that still does `import { mappers } from '@/store'` keeps working.
